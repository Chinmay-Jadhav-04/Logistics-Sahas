...
export default function RegistrationLoginPage({ onSubmit, formData, isLoading }) {
    ...
    return (
        <div className="w-full min-h-screen flex bg-[#F9FAFB]">
            ...
            <div className="flex flex-col w-1/2 min-h-screen items-center justify-center bg-white px-8">
                <form onSubmit={handleSubmit} className="flex flex-col items-center w-full max-w-md">
                    <div className="flex items-center mb-6">
                        <Package className="text-white bg-primary p-2 h-10 w-10 rounded-lg mr-3" />
                        <span className="text-2xl font-extrabold text-primary">Logistics</span>
                    </div>
                    <h1 className="font-extrabold text-2xl sm:text-3xl text-center mb-2 text-black">Create Your Account</h1>
                    ...
                    <button 
                        type="submit"
                        disabled={isLoading}
                        className="bg-primary text-white w-full h-12 rounded-md font-semibold text-lg mt-2 hover:bg-light-primary transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
                            <>
                    ...
                    <p className="mt-6 text-center text-gray-700 text-sm">
                        ...
                        <a href="./login" className="text-blue-600 ml-1 font-medium hover:underline">Sign In</a>
                    </p>
