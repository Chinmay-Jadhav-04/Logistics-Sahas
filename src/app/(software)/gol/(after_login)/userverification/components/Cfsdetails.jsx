...
const Cfsdetails = () => {
  ...
  return (
    <div className="bg-background border rounded-lg shadow-sm p-6">
      <h2 className="text-xl font-semibold text-foreground mb-6">CFS Details View Page</h2>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <label className="bg-primary hover:bg-blue-700 text-white px-4 py-2 rounded-lg cursor-pointer flex items-center space-x-2">
