...
const Facility = () => {
  const facilities = [
    { id: 1, name: 'Vehicle No, Route, Driver, Track Button', icon: <UtensilsCrossed /> }
  ];
  ...
  return (
    <div className="bg-background border rounded-lg shadow-sm p-6">
      <div className="flex items-start justify-between mb-4">
        <h2 className="text-lg font-semibold text-foreground">Facility Details</h2>
      ...
      <div className="flex items-center space-x-3 text-foreground">
        <span className="text-xl">{facilities[0].icon}</span>
